...
from app.core.models.models import Talent, TalentConstraint, ConstraintRule
from app.core.schema.talent_constraint_schema import ConstraintCreate, ConstraintUpdate, ConstraintType, Days, Shifts
